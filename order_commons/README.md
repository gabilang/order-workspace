...
public function main() {
    string greeting = gabilan:hello("Ballerina");
    io:println(gabilan:hello("Ballerina")); // Output: Hello, Ballerina
}
```
